...
export default function DashboardPage() {
    ...
    return (
      <div className="flex flex-col gap-6 py-6">
        <div className="text-center">
          <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-green-600 text-3xl shadow-md shadow-green-600/20">
            🏠
          </div>
          <h1 className="text-xl font-bold text-gray-900">Crea tu hogar</h1>
  ...
  return (
    <div className="flex flex-col gap-5 py-4">
      {/* Household card */}
      <div className="rounded-2xl bg-linear-to-br from-green-600 to-green-700 p-5 text-white shadow-lg shadow-green-600/20">
        <p className="text-xs font-medium text-green-200 uppercase tracking-wide">Tu hogar</p>
      ...
      <div className="grid grid-cols-3 gap-3">
        <Link
          href="/list/active"
          className="flex flex-col items-center gap-2 rounded-2xl bg-white border border-gray-100 p-4 shadow-sm hover:shadow-md transition-shadow"
        >
          <span className="flex size-10 items-center justify-center rounded-xl bg-green-50 text-green-600">
            <CartIcon size={20} />
          </span>
          <span className="text-xs font-semibold text-center text-gray-700">Lista activa</span>
        </Link>
        ...
        >
          ...
          <span className="text-xs font-semibold text-center text-gray-700">Catálogo</span>
        </Link>
        ...
        >
          ...
          <span className="text-xs font-semibold text-center text-gray-700">Precios</span>
        </Link>
      </div>
      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm border border-gray-100">
        <div className="flex items-center gap-3 mb-4">
          <span className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-purple-50">
            <UserPlusIcon size={18} className="text-purple-600" />
          </span>
          <div>
            <h2 className="font-semibold text-gray-800">Invitar miembros</h2>
            <p className="text-xs text-gray-400">Enlace válido por 7 días</p>
          </div>
        </div>
        ...
        {inviteLink ? (
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2">
              ...
              <span className="flex-1 truncate font-mono text-xs text-gray-600">{inviteLink}</span>
            </div>
            <Button
